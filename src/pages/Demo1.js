...
export const SearchProduct = () => {
  ...
  useEffect(() => {
    // Tạo hàm để tìm kiếm sản phẩm và lọc theo từ khóa và mức giá
    ...
    // Gọi hàm tìm kiếm sản phẩm và lọc khi state thay đổi
              ...
              <div className="row">
                <div className="col-12">
                  {Object.keys(priceRanges).map((rangeId, index) => (
                    <div
                      key={rangeId}
                      className={`custom-control custom-checkbox d-flex justify-content-between mb-2 ${
                        selectedPriceFilter === rangeId ? "selected" : ""
                      }`}
                    >
                      <input
                        type="checkbox"
