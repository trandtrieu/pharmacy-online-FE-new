          ...
          <div className="row align-items-center">
            {/* <div className="col-lg-3 text-left">
              <a href="#" className="text-decoration-none">
                <div className="brand">
                  <span className="brand-part brand-primary">DRUG</span>
                  <span className="brand-part brand-secondary">MART</span>
                </div>
              </a>
            </div> */}
            ...
            <div className="col-lg-3 text-right">
              <div className="d-inline-flex align-items-center">
                <div className="cart-new mr-3">
                  {/* <button
                    className="btn btn-primary px-3 ml-3 rounded-pill position-relative"
                    onClick={() => {
                      handleCartClick();
                    }}
                    style={{
