...
class FeedbackComponent extends Component {
  ...
  deleteFeedback = (id, user_id) => {
    ...
    if (shouldDelete) {
      FeedbackServices.deleteFeedback(id, user_id).then((res) => {
        this.setState({
  ...
  postFeedback = (e) => {
    ...
    if (this.state.opinion.trim() === "") {
      ...
      FeedbackServices.addFeedback(this.state.productId, accountId, feedback, token)
        .then((res) => {
              ...
              <div className="container-fluid">
                <div className="row">
                  <div className="col-md-12 d-flex flex-column align-items-center">
                    ...
                    <h6 className="mb-2">
                      I'm sorry! DrugMart couldn't find any feedback
                      in this product.
                    </h6>
                  </div>
                </div>
                              ...
                              <div className="pull-right reply">
                                ...
                                >
                                  <span
                                    ...
                                    className="m-1"
                                  >
                                    <FontAwesomeIcon style={{ fontSize: "16px", color: 'blue' }} icon={faReply} />
                                  </span>
                                  {feedback.user_id == accountId && (
                                    <span
                                      className="m-3"
                                      onClick={() =>
                                        this.deleteFeedback(feedback.feedback_id, accountId)
                                      }
                                    >
                                      <FontAwesomeIcon
                                        style={{ fontSize: "16px", color: '	#B22222' }}
                                        icon={faTrash}
                                      />{" "}
