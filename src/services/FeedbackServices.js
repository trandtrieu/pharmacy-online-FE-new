...
class FeedbackServices {
    ...
    addFeedback(productId, user_id, feedback) {
        return axios.post(FEEDBACK_API_BASE_URL1 + "product/" + productId + "/feedback/add/" + user_id, feedback)
    }

    getAverageRatingByProductId(productId) {
        return axios.get(FEEDBACK_API_BASE_URL1 + "product/" + productId + "/averageRating")
    }
